...
return (<>
    ...
    <div className="rules-container">
      ...
      <p>
        ...
        thinks of a three-digit number, and the other player must guess this number.
      </p>
      <p>
        The player makes a guess, and the first player reveals the number of "bulls"
        (correct digits in correct positions) and "cows" (correct digits in
        incorrect positions).
      </p>
      <p>
        The goal of the player is to guess the hidden number in the minimum number of moves.
      </p>
      ...
      <p>
        Good luck in guessing the number and winning the "Bulls and Cows" game!
      </p>
    </div>
